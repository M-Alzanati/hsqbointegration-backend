...
async function getQuotesByDealId(
  ...
  logMessage("DEBUG", "📄 Fetched HubSpot associations by deal ID", {
    dealId,
    associations,
  });
  ...
  logMessage("DEBUG", "📄 Fetched HubSpot quotes by IDs", { quoteIds });
  ...
  logMessage("INFO", "✅ Loaded quotes associated to deal", {
    dealId,
    count: quotes.length,
  });
  return quotes;
